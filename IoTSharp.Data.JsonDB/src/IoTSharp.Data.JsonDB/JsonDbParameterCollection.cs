...
namespace IoTSharp.Data.JsonDB
{
    ...
    public sealed class JsonDbParameterCollection : DbParameterCollection
    {
        ...
        public override int IndexOf(string parameterName)
        {
            ...
            {
                var currentParameterName = _parameters[i].ParameterName;
                if (string.Equals(NormalizeParameterName(currentParameterName), normalized, StringComparison.OrdinalIgnoreCase))
                {
                    return i;
                }
            }
